...
function MyPage() {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      try {
        const request = await fetch('http://localhost:5000/api/auth/profile', {  // /profile 엔드포인트로 GET 요청
          method: 'GET',
    ...
    const getUserData = async (email) => {
      try {
        const request = await fetch('http://localhost:5000/api/mypage/defaultdata', {
          method: 'POST',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const request = await fetch('http://localhost:5000/api/mypage/datasubmit', {
        method: 'PUT',
        headers: { 'content-type': 'application/json; charset=UTF-8' },
  ...
  const handleSecessionConfirm = async () => {
    try {
      const request = await fetch('http://localhost:5000/api/mypage/', {
        method: 'DELETE',
        ...
        <form id="user-form" onSubmit={handleSubmit}>
          <div className="mypage-form-row">
            <div className="mypage-form-column">
              ...
              <div className="mypage-form-field">
                <label className="mypage-label" htmlFor="email"><span>*</span> E-mail :  </label>
              ...
              <div className="mypage-form-field">
                <label className="mypage-label" htmlFor="confirmPassword"><span>*</span> Confirm Password : </label>
              ...
              <div className="mypage-form-field">
                <label className="mypage-label" htmlFor="birthdate"><span>*</span> BirthDate : </label>
            ...
            <div className="mypage-form-column">
              ...
              <div className="mypage-form-field">
                <label className="mypage-label" htmlFor="accountNo">Account No : </label>
                <input className="mypage-form-input" type="text" id="accountNo" name="accountNo" value={formData.accountNo} onChange={handleChange} />
              </div>

              <div className="mypage-form-field">
                <label className="mypage-label" htmlFor="holdingAsset">Holding Asset : </label>
